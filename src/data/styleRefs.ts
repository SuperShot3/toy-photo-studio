...
export const BUILT_IN_STYLE_REFS: StyleSceneRef[] = [
  {
    ...
    prompt:
      'Luxury florist campaign, understated, romantic, realistic, bright and airy — not dark or moody.\n\nWoman cropped from just below the nose to mid-thigh; eyes and most of the face out of frame. Dark hair pulled neatly back. Minimal sleeveless ivory/white V-neck fitted dress, very delicate understated jewelry.\n\nShe holds the exact reference bouquet with both hands at waist level, slightly to the right of her body. Bouquet is large and dominant, covering much of her torso, blooms facing slightly toward the camera, occupying about half the frame width.\n\nPlain pale cream / light ivory seamless studio, well-lit and luminous. No furniture, decorations, or extra objects. Bright, even, flattering diffused studio light with a soft fill so skin, dress, and blooms stay clear and luminous; only gentle, light shadows. Keep the whole frame nice, bright, and inviting — not underexposed, charcoal, or dim. Realistic skin and flower texture, not glossy.\n\nModel slightly left of center; bouquet centered/right as the main focus. Leave a calm, light lower band (~24%) for product-name type.',
